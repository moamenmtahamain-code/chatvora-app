...
start "ChatWave Backend" /D "%~dp0backend" cmd /k "set HOST=0.0.0.0&& set PORT=5000&& node server.js"

REM Start frontend in a new terminal (keeps window open)
start "ChatWave Frontend" /D "%~dp0frontend" cmd /k "npm run dev"
